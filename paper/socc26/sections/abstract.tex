...
visible first at runtime.  We present \textsc{G-port}, a guarded worker-service
controller whose coded arm keeps the sparse-flexible code fixed while changing
the runtime order in which recoverable row sets are exposed.  It combines
